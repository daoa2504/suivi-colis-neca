    ...
    return (
        <main className="p-6 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <Link
                    href="/admin/payments"
                    className="block p-6 bg-white rounded-lg border shadow-sm hover:shadow-md hover:border-emerald-400 transition-all"
                >
                    <div className="text-3xl mb-2">💳</div>
                    <h2 className="font-semibold text-lg mb-1">État de paiement</h2>
                    <p className="text-sm text-gray-600">
                        Liste de tous les colis filtrable par état (payé / partiel / non payé) et direction.
                    </p>
                </Link>
