// app/admin/ca/[trackingId]/quick-actions/QuickActionsForm.tsx
"use client";
...
const ACTIONS: Action[] = [
    {
        label: "📦 À la douane",
        type: "IN_CUSTOMS",
        description: "Colis à la douane (Canada)",
    },
    {
        label: "✅ Récupéré par agent",
        type: "PICKED_UP",
        description: "Colis récupéré par un agent Canada",
    },
    {
        label: "🚚 Livraison en cours",
        type: "OUT_FOR_DELIVERY",
        description: "Colis en cours de livraison vers le client",
    },
];
